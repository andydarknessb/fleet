...
try {
  ...
  foreach ($f in '_common.ps1','check-policy.ps1','assignment.js','premises.js','work-state.js','exclusions.js','notify.js') { [IO.File]::Copy("$sourceRoot\bin\$f", "$testRoot\bin\$f") }
