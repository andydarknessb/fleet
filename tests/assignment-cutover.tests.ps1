...
try {
  ...
  foreach ($f in '_common.ps1','launch.ps1','recover.ps1','cutover-assignment.ps1','assignment.js','assignment-parity.js','work-state.js','exclusions.js','notify.js') { [IO.File]::Copy("$sourceRoot\bin\$f", "$testRoot\bin\$f") }
